...
/**
 *  \file       core/modules/traspasomultiempresa/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_traspaso
 */
class pdf_standard_traspaso extends ModelePDFTraspaso
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	Traspaso	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('TRASPASOMULTIEMPRESA_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('TRASPASOMULTIEMPRESA_DRAFT_WATERMARK')));
		}
		...
		if ($current_y < $pdf->getY()) {
            ...
            if (!empty($object->id)) {
                    ...
                    if ($res_core && $this->db->num_rows($res_core) > 0) {
                            ...
                            $id_almacen_orig = $obj_core->fk_warehouse_origen;
                            $id_entidad_dest = $obj_core->entidadDestino;
	...
	protected function _pagefoot(&$pdf, $object, $outputlangs, $hidefreetext = 0){
		global $conf;
		$showdetails = 1; // Forzado: mostramos nombre+dirección+teléfono, sin datos fiscales (RFC, capital, etc. que van en showdetails 2/3)
