...
/**
 *  \file       traspasoline_contact.php
 *  \ingroup    traspasomultiempresa
 *  \brief      Tab for contacts linked to Traspasoline
 */
...
$title = $langs->trans("Traspasoline")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-traspasomultiempresa page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Traspasoline"), -1, $object->picto);
