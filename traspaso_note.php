...
/**
 *  \file       traspaso_note.php
 *  \ingroup    traspasomultiempresa
 *  \brief      Tab for notes on Traspaso
 */
...
$title = $langs->trans('Traspaso').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Traspaso"), -1, $object->picto);
