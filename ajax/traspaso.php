...
/**
 *       \file       htdocs/traspasomultiempresa/ajax/traspaso.php
 *       \brief      File to return Ajax response on traspaso list request
 */
...
// Security check
if (!$user->hasRight('traspasomultiempresa', 'traspaso', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax traspasomultiempresa/ajax/traspaso.php");
