...
/**
 *       \file       htdocs/traspasomultiempresa/ajax/traspasoline.php
 *       \brief      File to return Ajax response on traspasoline list request
 */
...
// Security check
if (!$user->hasRight('traspasomultiempresa', 'traspasoline', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax traspasomultiempresa/ajax/traspasoline.php");
