...
/**
 *  \file       traspaso_agenda.php
 *  \ingroup    traspasomultiempresa
 *  \brief      Tab of events on Traspaso
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Traspaso")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Traspaso"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_traspaso_'.$object->id;
