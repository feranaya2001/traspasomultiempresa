...
/**
 *  \file       traspaso_contact.php
 *  \ingroup    traspasomultiempresa
 *  \brief      Tab for contacts linked to Traspaso
 */
...
$title = $langs->trans("Traspaso")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Traspaso"), -1, $object->picto);
